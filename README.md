...
### Disposable的使用
[Disposable的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/DisposableExampleActivity.java)
...
##### Single的操作符
[Single的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/SingleObserverActivity.java)
...
##### Completable的使用
[Completable的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/CompletableObserverExampleActivity.java)

用于不需要知道任何返回值，只需要知道是否结束或错误
使用场景:例如请求接口更新服务端数据，我们只需要知道是否更新成功，不需要知道更新后返回的数据。

### 创建操作
[创建操作法的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/CreationExampleActivity.java)
...
##### Map操作符的使用
[Map的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/MapExampleActivity.java)

Map操作符对原始Observable发射的每一项数据应用一个你选择的函数，然后返回一个发射这些结果的Observable。
RxJava将这个操作符实现为map函数，这个操作符默认不在任何特定的调度器上执行。

##### Buffer的使用
[Buffer的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/BufferExampleActivity.java)
...
##### Zip的使用
[Zip的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/ZipExampleActivity.java)
...
##### Merge的使用
[Merge的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/MergeExampleActivity.java)
...
##### Take的使用
[Take的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/TakeExampleActivity.java)
...
##### Filter的使用
[Filter的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/FilterExampleActivity.java)
...
##### Skip的使用
[Skip的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/SkipExampleActivity.java)
...
### 算术和聚合操作
[算术和聚合操作的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/ReduceExampleActivity.java)
...
##### Replay
[Replay的示例](https://github.com/lxhAndSmh/MvpDemo/blob/master/app/src/main/java/com/liu/mvpdemo/activity/operators/ReplayExampleActivity.java)
